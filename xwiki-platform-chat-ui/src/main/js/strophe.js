 ...
 *    A new Strophe.Builder object.
 */
function $xmppmsg(attrs) { return new Strophe.Builder("message", attrs); }
/** Function: $iq
...
if (callback) {
    callback(Strophe, $build, $xmppmsg, $iq, $pres);
}

})(function () {
    window.Strophe = arguments[0];
    window.$build = arguments[1];
    window.$xmppmsg = arguments[2];
